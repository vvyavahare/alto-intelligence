# alto-intelligence-exercise
alto-intelligence-exercise project
...
Please fill RestManager class with the appropriate data structures and implement its constructor and three public methods. You are encouraged to expand the other two classes too and add new methods there at your discretion.


NOTE: please do not upload the solution to any (public) space. Just send the zipped class files attached to the reply.
